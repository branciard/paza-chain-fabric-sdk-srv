...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pazachainfabricsdksrv@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pazachainfabricsdksrv API";

        private String description = "pazachainfabricsdksrv API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pazachainfabricsdksrv";
